...
public class KafkaConfig{
    ...
    @Bean
    ConsumerFactory<String, NotificationCreatedEvent> consumerFactory(){
        ...
        config.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, NotificationCreatedEvent.class.getName());
        return new DefaultKafkaConsumerFactory<>(config);
    }

    @Bean
    ConcurrentKafkaListenerContainerFactory<String, NotificationCreatedEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, NotificationCreatedEvent> consumerFactory,
